...
updated: 2026-08-29T11:11:00-03:00
---

## Current Focus

hypothesis: Confirmada e corrigida localmente — a descoberta agora usa o roteiro completo e preserva recall sem repetir mensagens/anexos nem exceder 30 análises ranqueadas.
test: Implantar e repetir no Hermes o pedido original para a viagem Casamento Caio e Miriam, conferindo voos e hotéis encontrados/salvos.
expecting: As buscas usam SJP/FOR/NAT, Grossos e o roteiro completo; comprovantes reais de alta confiança são salvos, sem timeout e sem inventar dados.
next_action: Implantar a correção e solicitar verificação humana no Gmail/Telegram real.
